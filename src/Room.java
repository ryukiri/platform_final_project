...
public class Room {
    ...
    private ArrayList <Enemy> contentEnemies;
    ...
    public Room(int newX, int newY, GameBoard g, String newSymbol){
        ...
        contentEnemies = new ArrayList<Enemy>();
    ...
    public void addContentEnemies(Enemy actor){
        contentEnemies.add(actor);
    }
...
/*
    ...
    public ArrayList <Enemy> getContentEnemies(){
